...
__global__
void conv3DKernel(float *M, float*P, int width, int height, int depth, int r){
...
int main(int argc, char **argv)
{
    ...
    CHECK_CUDA((cudaMemcpyToSymbol(F, h_F.data(), fBytes)));
    ...
    conv3DKernel<<<gridDim, blockDim>>>(d_M, d_P, W, H, D, r);
